# Aplikacja-Pogodowa
Żeby program zadziałał:
1. Należy pobrać wszystkie pliki (main.html, script.js, style.css, favicon4.png).
...
5. W prawym panelu w miejscu "Wyszukaj Misto", wpisujemy dowolne miasto w języku polskim i klikamy przycisk "Sprawdź".
